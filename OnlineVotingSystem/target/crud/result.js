...
function getAllVotes() {
    ...
    xhttp.onreadystatechange = function () {
        if (this.readyState == 4 && this.status == 200) {
            ...
            _displayNonPolling(response.nonPollingDetails);
            _displayPartyCounts(response.partyCounts);
            _displayGenderCounts(response.genderCount);
            _wardwisePartyCounts(response.groupedVotesbyward);
            displayGraphForKeyValue(response.genderCount);
            displayGraphForKeyValueParty(response.partyCounts);
...
function _wardwisePartyCounts(data) {
    var html = "<table border='1|1'>";
    html += "<tr>";
    html += "<th>Ward</th>";
    ...
    html += "</table>";
    document.getElementById("groupedVotesbyward").innerHTML = html;
}
